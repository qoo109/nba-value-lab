...
- 2023-24 source archive reconciliation 曾確認 `nbastats` 有 1,230 場、`pbpstats` 有 1,228 場；這是 recovery 前的歷史狀態。後續已用官方 CDN PBP 補齊兩場，現行 Silver／Gold 均為 5,826 場、剩餘缺口為 0。
