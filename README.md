...
目前已完成五季 Historical Gold、Logistic + Elo Walk-forward v2、Calibration Gate、Closing Market Benchmark、Market Residual Analysis、Rest／Travel holdout、官方傷病報告 importer、Player Identity、Expected Minutes research proxy、Team Injury Burden、Multi-report Injury Panel、Injury Residual Audit，以及 2023-24 Historical Silver source archive reconciliation。
...
- 一次性 reconciliation request 已消耗，禁止重跑；下一步是 privacy-safe source-gap exception manifest design，不是 Silver／Gold rebuild。
...
Legacy UI 內的勝率與候選仍可能包含示範資料。正式研究管線已完成 Walk-forward、Calibration Gate、Closing Market Benchmark、多個 holdout／殘差實驗與 source archive reconciliation，但尚未完成 real timestamped odds backfill、executable market backtest、CLV、EV、ROI、Drawdown 與正式鎖版前瞻測試。
