...
function priceBand(odds) {
  if (!Number.isFinite(odds) || odds <= 1) return { label: "無效市場賠率", margin: null, eligible: false };
  ...
  if (odds < modelG().price_bands[0].min) return { label: "極低市場賠率層", margin: null, eligible: false };
