...
const gradeInfo = {
  "ㄅ": { label: "ㄅ級・研究候選", tone: "qualified", rule: "核心賠率層通過對應安全邊際" },
  "ㄆ": { label: "ㄆ級・條件觀察", tone: "watch", rule: "接近門檻或該賠率層尚未開放" },
  "ㄇ": { label: "ㄇ級・賠率合理", tone: "fair", rule: "保守優勢為正但緩衝不足" },
...
const games = [
  {
    ...
    reasons: ["長期調整後淨效率與半場進攻支持 DEN", "覆蓋率、傷病確認與區間寬度通過核心條件", "目前賠率高於最低可接受賠率"],
  ...
  },
  {
    ...
    headline: "NYK 通過賠率門檻，但覆蓋率未達核心主推標準",
    build: { base: 69, adjustments: [["近期狀態", 1], ["對手品質", 0], ["攻防對位", 1], ["傷病輪替", 0], ["賽程休息", 1], ["戰術風格", 0], ["主場移動", 2]] },
    reasons: ["主場半場防守與籃板對位略有優勢", "保守勝率通過 V3 與 G1 核心賠率門檻"],
  ...
  },
  {
    ...
    headline: "OKC 勝率較高，但 1.45 的賠率仍未達 5pp 研究門檻",
