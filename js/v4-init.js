...
function loadV46Coordination() {
  return loadScriptOnce("./js/v4-6-model-coordination.js?v=5.1", "data-v46-coordination", () => typeof vDecision === "function" && typeof gDecision === "function");
}

function loadV410MultiMain() {
  return loadScriptOnce("./js/v4-10-multi-main.js?v=5.1", "data-v410-multi-main", () => typeof renderMultiMainSummary === "function");
}

function loadV47ResearchLog() {
  return loadScriptOnce("./js/v4-7-research-log.js?v=5.1", "data-v47-research-log", () => typeof initResearchLog === "function");
}

function loadV49LockStatus() {
  return loadScriptOnce("./js/v4-8-lock-status.js?v=5.1", "data-v49-lock-status", () => typeof initT60LockStatus === "function");
}

async function loadV5Ui() {
  await Promise.all([
    loadStylesheetOnce("./css/v5-tokens.css?v=5.1", "data-v5-tokens"),
    loadStylesheetOnce("./css/v5-layout.css?v=5.1", "data-v5-layout"),
    loadStylesheetOnce("./css/v5-components.css?v=5.1", "data-v5-components"),
    loadStylesheetOnce("./css/v5-theme-p1.css?v=5.1", "data-v51-theme"),
    loadStylesheetOnce("./css/v5-research-p1.css?v=5.1", "data-v51-research"),
    loadStylesheetOnce("./css/v5-mobile-p1.css?v=5.1", "data-v51-mobile"),
  ]);
  await loadScriptOnce("./js/v5/core/namespace.js?v=5.1", "data-v5-namespace", () => Boolean(window.NBAVL?.v5));
  await loadScriptOnce("./js/v5/utils/format.js?v=5.1", "data-v5-format", () => Boolean(window.NBAVL?.v5?.modules?.format));
  await loadScriptOnce("./js/v5/components/cards.js?v=5.1", "data-v5-cards", () => Boolean(window.NBAVL?.v5?.modules?.cards));
  await loadScriptOnce("./js/v5/components/drawer.js?v=5.1", "data-v5-drawer", () => Boolean(window.NBAVL?.v5?.modules?.drawer));
  await loadScriptOnce("./js/v5/pages/dashboard.js?v=5.1", "data-v5-dashboard", () => Boolean(window.NBAVL?.v5?.modules?.dashboard));
  await loadScriptOnce("./js/v5/pages/performance-dashboard.js?v=5.1", "data-v51-performance", () => Boolean(window.NBAVL?.v5?.modules?.performanceDashboard));
  await loadScriptOnce("./js/v5/pages/research-timeline.js?v=5.1", "data-v51-timeline", () => Boolean(window.NBAVL?.v5?.modules?.researchTimeline));
  await loadScriptOnce("./js/v5/bootstrap.js?v=5.1", "data-v5-bootstrap", () => typeof window.NBAVL?.v5?.prepare === "function");
}
...
async function init() {
  ...
  document.documentElement.dataset.appVersion = v5Ready ? "V5.1" : "V4.10";
}
