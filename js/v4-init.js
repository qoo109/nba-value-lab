...
async function loadV5Ui() {
  ...
  await loadScriptOnce("./js/v5/pages/dashboard.js?v=5.3", "data-v5-dashboard", () => Boolean(window.NBAVL?.v5?.modules?.dashboard));
...
async function init() {
  ...
  document.documentElement.dataset.appVersion = v5Ready ? "V5.3" : "V4.10";
}
