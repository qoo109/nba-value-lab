...
const gradeInfo = {
  ...
  "ㄇ": { label: "ㄇ級・價格合理", tone: "fair", rule: "價格略有優勢但緩衝不足" },
...
const games = [
  {
    ...
    reasons: ["長期調整後淨效率與半場進攻均佔優", "休息日與核心輪替完整度符合模型門檻", "目前價格高於最低可接受賠率"],
  ...
  },
  {
    ...
    grade: "ㄇ", headline: "可能贏球，但目前價格沒有足夠安全邊際",
  ...
  },
  {
    ...
    grade: "不支持", headline: "球隊較強，不代表 1.45 是合理價格",
